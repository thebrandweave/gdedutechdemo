...
<head>
    ...
    <title>FAQ Management - GD Edu Tech Admin</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row g-0 flex-nowrap">
            ...
            <div class="col-auto col-md-3 col-xl-2 px-0 sidebar sticky-top vh-100 overflow-auto hide-scrollbar d-flex flex-column">
                ...
                <ul class="nav nav-pills flex-column mb-auto p-2 w-100" id="menu">
                    ...
                    <li class="w-100"><a href="./" class="nav-link active"><i class="bi bi-question-circle me-2"></i> FAQ</a></li>
            ...
            <div class="col min-vh-100 d-flex flex-column">
                ...
                <div class="bg-white border-bottom px-4 py-3 d-flex align-items-center justify-content-between">
                    <div>
                        <h4 class="fw-bold text-dark mb-0">FAQ Management</h4>
                        <span class="text-muted small">Manage frequently asked questions across the website</span>
                    </div>
                    ...
                    <div class="row g-4 mb-4">
                                    ...
                                    <div class="card shadow-sm border-0 rounded-4 h-100 overflow-hidden">
                                        <div class="bg-light p-3 border-bottom d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h6 class="fw-bold text-dark mb-0"><?php echo htmlspecialchars($faq['question']); ?></h6>
                                            </div>

                                            <div class="d-flex gap-1">
                                                <a href="edit_faq.php?id=<?php echo $faq['faq_id']; ?>" class="action-icon" title="Edit FAQ">
                                                    <i class="bi bi-pencil-fill text-warning"></i>
                                                </a>
                                                <a href="index.php?delete=1&id=<?php echo $faq['faq_id']; ?>" class="action-icon text-danger" onclick="return confirm('Are you sure you want to delete this FAQ?');" title="Delete FAQ">
                                                    <i class="bi bi-trash-fill"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body p-4">
                                            <p class="text-secondary lead fs-6 mb-0" style="line-height: 1.7;">
                                                <?php echo htmlspecialchars($faq['answer']); ?>
                                            </p>
                                        </div>
                                        <div class="card-footer bg-white border-top text-muted small">
                                            <i class="bi bi-clock me-1"></i> Posted on: <?php echo !empty($faq['created_at']) ? date('M d, Y', strtotime($faq['created_at'])) : '-'; ?>
                                        </div>
                                    </div>
                                </div>
                            <?php endwhile; ?>
                        <?php else: ?>
                            <div class="col-12 text-center py-5 text-muted">
                                <i class="bi bi-patch-question fs-1 text-secondary opacity-50 d-block mb-2"></i>
                                No FAQs added yet.
                            </div>
                        <?php endif; ?>
                    </div>
