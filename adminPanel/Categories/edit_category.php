...
<head>
    ...
    <title>Edit Category - GD Edu Tech Admin</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row g-0 flex-nowrap">
            ...
            <div class="col min-vh-100 d-flex flex-column">
                ...
                <div class="bg-white border-bottom px-4 py-3 d-flex align-items-center justify-content-between">
                    <div>
                        <h4 class="fw-bold text-dark mb-0">Edit Category #<?php echo $category_id; ?></h4>
                        <span class="text-muted small">Update title or description for this course category</span>
                    </div>
                ...
                <div class="p-4 flex-grow-1 d-flex justify-content-center align-items-start">
                    ...
                    <div class="card shadow-sm border-0 rounded-4 p-4 p-md-5 w-100" style="max-width: 680px;">
                        ...
                        <form method="POST" action="edit_category.php?id=<?php echo $category_id; ?>" autocomplete="off">
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-start-0" id="name" name="name" value="<?php echo htmlspecialchars($name); ?>" required maxlength="100">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="description" class="form-label font-weight-semibold text-dark">Category Description</label>
                                <textarea class="form-control" id="description" name="description" rows="4" maxlength="500"><?php echo htmlspecialchars($description); ?></textarea>
                            ...
                            <div class="d-flex justify-content-end gap-2 pt-2">
                                ...
                                <button type="submit" class="btn btn-warning px-4 py-2.5 rounded-3 fw-bold text-dark">
                                    <i class="bi bi-check-circle-fill me-1.5"></i> Update Category
                                </button>
                            </div>
                        </form>
                    </div>
