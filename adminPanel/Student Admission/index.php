                                ...
                                <tbody>
                                    <?php if (mysqli_num_rows($result) > 0): ?>
                                        <?php while ($admission = mysqli_fetch_assoc($result)): ?>
                                            <tr>
                                                <td>
                                                    <span class="badge bg-primary bg-opacity-10 text-primary border border-primary-subtle px-2.5 py-1 rounded-pill font-monospace fw-bold fs-6">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="d-flex flex-column align-items-center gap-1">
                                                        <a href="<?php echo $verify_url; ?>" target="_blank" title="Verify Certificate (Opens live tab)">
                                                            <img src="<?php echo $qr_api_url; ?>" alt="QR Code" class="rounded-2 border p-1 bg-white shadow-sm" style="width: 36px; height: 36px; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.2)';" onmouseout="this.style.transform='scale(1)';">
                                                        </a>
                                                        <a href="download_qr.php?student_id=<?php echo urlencode($admission['student_id']); ?>" class="btn btn-sm btn-outline-secondary py-0 px-2 rounded-pill" style="font-size: 0.62rem;" title="Download QR Image">
